...
ggsave(file.path(qc.dir, "Mock_abs_genus.tiff"), width = 8, height = 10, dpi = 300)
ggsave(file.path(qc.dir, "Mock_abs_genus.svg"), width = 8, height = 10, dpi = 300)
...
ggsave(file.path(qc.dir, "Mock_rel_genus.tiff"), width = 8, height = 10, dpi = 300)
ggsave(file.path(qc.dir, "Mock_rel_genus.svg"), width = 8, height = 10, dpi = 300)
...
ggsave(file.path(qc.dir, "Mock_rel_species.tiff"), width = 15, height = 15, dpi = 300)
ggsave(file.path(qc.dir, "Mock_rel_species.svg"), width = 15, height = 12, dpi = 300)
...
plot_bar(physeq_expected_mock, y =  "Abundance", title = paste("Abundance from top", n, "ASVs\nbased on Genus"), fill="Genus")+ facet_wrap(~Study_Nr, scales="free_x") + 
  geom_bar(aes(color=Genus, fill=Genus), stat = "Identity", position = "stack") + thm +
  guides(fill = guide_legend(ncol = 2, title = NULL),
         color = guide_legend(ncol = 2, title = NULL))


ggsave(file.path(qc.dir, "Mock_exp_genus.tiff"), width = 8, height = 10, dpi = 300)
ggsave(file.path(qc.dir, "Mock_exp_genus.svg"), width = 8, height = 10, dpi = 300)
